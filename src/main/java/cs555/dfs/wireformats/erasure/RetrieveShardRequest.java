...
public class RetrieveShardRequest implements Message {
    private MessageHeader messageHeader;
    private Shard shard;

    public RetrieveShardRequest(String serverAddress, String sourceAddress, Shard shard) {
    ...
    public int getProtocol() {
        return Protocol.RETRIEVE_SHARD_REQUEST;
    }
    ...
    public RetrieveShardRequest(byte[] bytes) {
        try {
